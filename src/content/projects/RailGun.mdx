...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/Railgun_design.png" class="img-fluid rounded z-depth-1" alt="railgun design" loading="lazy" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/Railgun_design_boven.png" class="img-fluid rounded z-depth-1" alt="railgun design topdown" loading="lazy" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/Railgun_circuit.png" class="img-fluid rounded z-depth-1" alt="railgun circuit" loading="lazy" />
    </div>
</div>
<div class="caption">
...
#### Old Report Download
The old report can be downloaded below.
<PdfDownload
  href="/assets/pdf/PWS_Railgun_2020_Fedde&Max_Versie_final.docx.pdf"
  label="Download Railgun report"
/>