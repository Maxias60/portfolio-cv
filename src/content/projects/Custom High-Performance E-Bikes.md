...
description: A seemingly never ending project where I design, develop, and program my own custom high-performance E-bike based on the open-source VESC project.
importance: 1
category: Favorites
